...
const SCREENS = [
  ...
  },
  {
    emoji: '🏆',
    title: 'Цель игры',
    subtitle: 'Дойти до ступени A',
    text: 'У каждой команды есть «документ» — свой ранг карт. Начнёте с 6, а за каждый выигранный кон поднимаетесь выше: 6 → 10 → J → Q → K → A.\n\nПобеждает команда, которая дойдёт до A и выиграет кон.',
    accent: '#2ecc71',
  },
  {
    emoji: '👆',
  ...
  },
  {
    ...
    subtitle: 'Фальш · Своп · Передача',
    text: '🃏 Фальш — если враг подкинул не по правилам, объяви фальш (он вернёт карту).\n\n🔄 Своп — если партнёр вышел, можно отдать ему свои карты (1 раз за кон).\n\n📤 Передача документов — если у тебя только документы, передай их партнёру.',
    accent: '#8e44ad',
  },
  {
    emoji: '🚀',
